...
export function PoliceLogin({ onLogin, isDarkMode }: PoliceLoginProps) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-blue-200">Cyber Crime Investigation Cell</p>
            </div>
          </div>
          
          <div className="mt-12 p-6 bg-blue-800/50 rounded-xl border border-blue-700">
            <h3 className="text-white mb-4">Officer Portal Access</h3>
            <ul className="space-y-3 text-blue-200">
              ...
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                CFCFRMS & CCTNS integration
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                Bank coordination tools
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                Analytics dashboard
          ...
          <div className="mt-8 p-4 bg-orange-500/20 border border-orange-500/30 rounded-lg">
            <p className="text-orange-200">
              <strong>Security Notice:</strong> This portal is restricted to authorized police officers only. All access is logged and monitored.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-blue-700 pt-6">
          <p className="text-blue-200">
            Odisha Police Cyber Crime Investigation Cell
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
              Secure access to case management system
            </p>
          </div>
